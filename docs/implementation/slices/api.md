...
- **Unresolved gates or risks:** Hosting target remains open. The throttle keys on `request.client`, which needs uvicorn's proxy-header flags behind Caddy (recorded in tech-stack.md for the deployment slice).
- **Final PR:** [#30](https://github.com/cblack34/inventory/pull/30).
